...
public class CertificateService {
        ...
        private final DeviceRgb PRIMARY_DARK = new DeviceRgb(10, 91, 91); // #0A5B5B
        private final DeviceRgb SECONDARY_DARK = new DeviceRgb(44, 95, 138); // #2C5F8A
        private final DeviceRgb TEXT_DARK = new DeviceRgb(30, 42, 54); // #1E2A36
        ...
        public byte[] generateCertificate(String userDocument, Long courseId) {
                ...
                try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
                        ...
                        String certificadoId = "CERT-" + courseId + "-" + user.getId() + "-"
